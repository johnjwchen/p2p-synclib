...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="p2p_synclib",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC11p2p_synclib12PPSyncManger")
@interface PPSyncManger : NSObject
@property (nonatomic, copy) void (^ _Nonnull receiveHandler)(NSData * _Nonnull);
- (void)broadcastWithUserData:(NSData * _Nonnull)userData handler:(void (^ _Nullable)(NSData * _Nonnull, BOOL))handler;
...
@interface PPSyncManger (SWIFT_EXTENSION(p2p_synclib)) <MCNearbyServiceAdvertiserDelegate>
...
@interface PPSyncManger (SWIFT_EXTENSION(p2p_synclib)) <MCNearbyServiceBrowserDelegate>
...
@interface PPSyncManger (SWIFT_EXTENSION(p2p_synclib)) <MCSessionDelegate>
